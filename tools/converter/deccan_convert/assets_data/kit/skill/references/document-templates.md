...
| `{{PREPARED_BY}}` | string | Cover author line. Office, team, or named individual — resolved per `SKILL.md` → Attribution: defaults to the requesting user, never the system maintainer. |
